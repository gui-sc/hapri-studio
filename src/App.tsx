...
const projects: Project[] = [
    ...
    },
    {
        ...
        description:
            "Afeto, rotina e apetite em uma identidade que dá vontade de ficar.",
        image: "/gomes.png",
        tone: "#e9c6a4",
    ...
    },
    {
        ...
        description:
            "Um universo visual para acessórios que acompanham todos os dias.",
        image: "/perola.png",
        tone: "#d7d5ce",
    ...
    },
    {
        ...
        description:
            "Energia de rua, precisão de marca e uma comunidade em movimento.",
        image: "/uzi.png",
        tone: "#bcc9c8",
...
const services = [
    {
        ...
        title: "Estratégia",
        description:
            "Clareza para decidir o que a marca diz, para quem e por que agora.",
    ...
    },
    {
        ...
        description:
            "Ideias com forma, ritmo e uma assinatura que não se perde no feed.",
        image: "/perola.png",
    },
    {
        number: "03",
        title: "Conteúdo",
        description:
            "Sistemas de conteúdo que transformam presença em conversa contínua.",
        image: "/gomes.png",
    },
    {
        number: "04",
        title: "Performance",
        description:
            "Leitura de dados, teste e otimização para fazer a atenção avançar.",
        image: "/tasse.png",
    },
];
...
const processSteps = [
    [
        "entender",
        "Ouvimos o negócio antes de propor a próxima postagem. O contexto é a matéria-prima da estratégia.",
    ],
    [
        "questionar",
        "Encontramos o que está repetido, silencioso ou pronto para ser visto de outro jeito.",
    ],
    [
        "construir",
        "Criamos uma linguagem visual e verbal que cabe no mundo real da marca.",
    ],
    [
        "testar",
        "Colocamos as ideias na rua, observamos a resposta e ajustamos com intenção.",
    ],
    [
        "medir",
        "Resultado não é só número. É clareza para decidir o próximo movimento.",
    ],
] as const;
    ...
    return (
        ...
        >
            ...
            <div className="project-card__art">
                ...
                />
                <span className="project-card__stamp">
                    HAPRI
                    <br />
                    ARCHIVE
                </span>
        ...
        >
            ...
            <div className="case-modal__body">
                <div className="case-modal__copy">
                    ...
                    <h2>{project.title}</h2>
                    <p className="case-modal__description">
                        {project.description}
                    </p>
                    ...
                    <p className="case-modal__note">
                        Um recorte do nosso jeito de transformar estratégia em
                        presença, com espaço para a marca respirar e ser
                        lembrada.
                    </p>
                </div>
                <div
                    className="case-modal__media"
                    style={{ backgroundColor: project.tone }}
                >
                    <img
                        src={project.image}
                        alt={`Detalhe visual do projeto ${project.title}`}
                    />
                    <span>
                        Arraste o olhar
                        <br />
    ...
    return (
        ...
        >
            ...
            <div className="reel-modal__stage">
                ...
                <div className="reel-modal__title">
                    MAKE
                    <br />
                    <i>IT</i>
                    <br />
                ...
                <div className="reel-modal__play">
                    <FaPlay />
                </div>
            </div>
            <div className="reel-modal__foot">
                <span>SOUND ON / IMAGINE A BATIDA</span>
                <span>01 — 04</span>
            </div>
        </motion.div>
    );
...
function App() {
    ...
    useEffect(() => {
        document.body.style.overflow =
            isMenuOpen || Boolean(selectedProject) || isReelOpen
                ? "hidden"
                : "";
        return () => {
            document.body.style.overflow = "";
        ...
        <MotionConfig reducedMotion={reducedMotion ? "always" : "never"}>
            <div className="app-shell">
                ...
                >
                    ...
                    <div className="site-nav__context">
                        {isScrolled
                            ? "ORANGE PORTAL / 2026"
                            : "ESTÚDIO CRIATIVO"}
                    </div>
                ...
                <main>
                    ...
                    >
                        ...
                        >
                            <div className="hero__portal-inner">
                                <img src="/logo.png" alt="Logo Hapri Studio" />
                            </div>
                        </motion.div>
                        <div className="hero__meta">
                            <span>Florianópolis — Brasil</span>
                            <span>
                                Scroll para entrar <FaArrowDown />
                            </span>
                        </div>
                        <div className="hero__content">
                            ...
                            <div className="hero__bottom">
                                <p>
                                    Estratégia, design e conteúdo para marcas
                                    que não vieram para preencher espaço.
                                </p>
                                <MagneticButton
                    ...
                    <section id="estudio" className="manifesto section-cream">
                        <div className="section-frame">
                            ...
                            <div className="manifesto__headline">
                                ...
                                <p className="manifesto__indent">
                                    para preencher <em>feed.</em>
                                </p>
                                <p className="manifesto__small">
                                    Criamos marcas
                                </p>
                                <p className="manifesto__indent manifesto__accent">
                                    que ocupam espaço.
                                </p>
                            </div>
                            <div className="manifesto__foot">
                                <span>
                                    Uma agência para quem quer movimento
                                </span>
                                <span>↓ continue</span>
                            </div>
                        </div>
                    ...
                    <section id="trabalhos" className="projects section-black">
                        <div className="section-frame">
                            ...
                            <div className="projects__intro">
                                <h2>
                                    O que a gente <i>moveu.</i>
                                </h2>
                                <p>
                                    Projetos que começam em uma pergunta e
                                    terminam em alguma coisa impossível de
                                    ignorar.
                                </p>
                            </div>
                            ...
                            <div className="projects__end">
                                <span>04 — MAIS EM BREVE</span>
                                <span>
                                    O próximo projeto começa numa conversa.
                                </span>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="servicos" className="services section-cream">
                        <div className="section-frame">
                            <div className="section-label">
                                <span>04 — O QUE FAZEMOS</span>
                                <span>Sem receita pronta</span>
                            </div>
                            <div className="services__grid">
                                <div className="services__heading">
                                    <p className="eyebrow">
                                        Um sistema, não um pacote
                                    </p>
                                    <h2>
                                        Ideias que
                                        <br />
                                    ...
                                    <p>
                                        Da estratégia ao último frame,
                                        construímos a parte que faz uma marca
                                        ser reconhecida antes mesmo do logo
                                        aparecer.
                                    </p>
                                </div>
                            ...
                            <div className="process__grid">
                                <div>
                                    ...
                                    <p className="process__note">
                                        Cada marca pede um ritmo. A gente entra
                                    ...
                                    {processSteps.map(
                                        ([title, copy], index) => (
                                            ...
                                            >
                                                <span>0{index + 1}</span>
                                                <strong>{title}</strong>
                                                <span className="process-step__plus">
                                                    {activeStep === index
                                                        ? "−"
                                                        : "+"}
                                                </span>
                    ...
                    <section className="reel-section section-black">
                        <div className="section-frame">
                            <div className="section-label section-label--light">
                                <span>06 — SHOWREEL</span>
                                <span>Somente o necessário</span>
                            </div>
                            <div className="reel-section__stage">
                                <div className="reel-section__copy">
                    ...
                    <section className="results section-cream">
                        <div className="section-frame">
                            <div className="section-label">
                                <span>07 — GENTE QUE CONFIOU</span>
                                <span>Feito junto</span>
                            </div>
                            <div className="results__headline">
                                <p>Presença que deixa</p>
                                <p className="results__accent">rastro.</p>
                            </div>
                            <div className="client-wall">
                                {clients.map((client, index) => (
                                    <div
                                        className="client-wall__item"
                                        key={client.name}
                                        style={
                                            {
                                                "--client-delay": `${index * 0.08}s`,
                                            } as CSSProperties
                                        }
                                    >
                                        <img
                    ...
                    <section id="lab" className="lab section-black">
                        <div className="section-frame">
                            <div className="section-label section-label--light">
                                <span>08 — HAPRI LAB</span>
                                <span>Teste, erro, descoberta</span>
                            </div>
                            <div className="lab__grid">
                                <div className="lab__copy">
                                    <p className="eyebrow">
                                        Um playground para ideias
                                    </p>
                                    <h2>
                                        Nem tudo precisa
                                        <br />
                                    ...
                                    <p>
                                        Aqui a gente experimenta combinações,
                                        formatos e pequenos acidentes felizes.
                                        Leve um poster com você.
                                    </p>
                                    <button
                                        type="button"
                                        className="text-link"
                                ...
                                >
                                    ...
                                    <strong>
                                        {posterPhrases[posterPhrase]}
                                    </strong>
                                    <small>
                                        estratégia é dar
                                        <br />
                                        forma ao que importa.
                                    </small>
                                    <i>✳</i>
                                </motion.div>
                            </div>
                    ...
                    <section id="contato" className="contact section-orange">
                        <div className="section-frame">
                            <div className="section-label section-label--dark">
                                <span>09 — CONTATO</span>
                                <span>O portal está aberto</span>
                            </div>
                            <div className="contact__main">
                                ...
                                <MagneticButton
                                    ...
                                    onClick={() =>
                                        window.open(
                                            "https://wa.me/5548996040786?text=Olá,%20vim%20pelo%20site%20da%20Hapri.%20Vamos%20conversar?",
                                            "_blank",
                                        )
                                    }
                                >
                            ...
                            <div className="contact__footer">
                                <div>
                                    <strong>HAPRI / STUDIO</strong>
                                    <span>
                                        Estratégia, design e conteúdo
                                        <br />
                                        para marcas em movimento.
                                    </span>
                                </div>
                                <div className="contact__links">
                                    ...
                                    <a href="mailto:oi@hapristudio.com">
                                        oi@hapristudio.com ↗
                                    </a>
                                </div>
                ...
                <footer className="site-footer">
                    <div>HAPRI STUDIO © {new Date().getFullYear()}</div>
                    <div>
                        feito com intenção <span>✳</span> sem atalhos
                    </div>
                    <button
                        type="button"
                        onClick={() => scrollToSection("home")}
                ...
                <AnimatePresence>
                    {isReelOpen && (
                        <ShowreelModal onClose={() => setIsReelOpen(false)} />
                    )}
                </AnimatePresence>
            </div>
        </MotionConfig>
